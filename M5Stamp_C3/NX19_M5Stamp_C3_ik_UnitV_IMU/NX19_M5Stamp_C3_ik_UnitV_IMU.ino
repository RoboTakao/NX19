...
{ 
  ...
  Dabble.begin("NX19__M5Stamp_C3");       //set bluetooth name of your device
...
{ 
  ...
  float xx = GamePad.getXaxisData();
  float yy = GamePad.getYaxisData();

  int eye_x = (int)map(xx, -7, 7, 100, 0);
  int eye_y = (int)map(yy, -7, 7, 100, 0);
  int head_x = (int)map(yy, -7, 7, -20, 20);
  int head_y = (int)map(xx, -7, 7, -20, 20);
  int head_z = (int)map(xx, -7, 7, -20, 20);
  int walk_fs = (int)map(yy, -7, 7, -20, 20);
  int walk_ss = (int)map(xx, -7, 7, -20, 20);
  int walk_ts = (int)map(xx, -7, 7, -10, 10);
